...
|---|---|---|---|
| `stomp` | `distance / 18` | (0.00, 0.0) (0.10, 0.9) (0.30, 1.0) (0.70, 0.55) (1.00, 0.0) | `× (1 - clamp(drone_height/12,0,1))` `× confidence` `× (planted_legs ≥ 3)` |
...
| `pounce` | `distance / 55` | (0.00, 0.0) (0.25, 0.35) (0.55, 1.0) (0.85, 0.60) (1.00, 0.0) | `× (1 - clamp(drone_speed/14,0,1))` `× (planted_legs ≥ 3)` `× has_los` |
